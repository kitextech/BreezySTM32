/*
   mpu6500.h : driver for Invensense MPU6500
...
void mpu6500_request_async_accel_read(int16_t *accData, volatile uint8_t *status_);
void mpu6500_request_async_gyro_read(int16_t *gyroData, volatile uint8_t *status_);
void mpu6500_request_async_temp_read(volatile int16_t *tempData, volatile uint8_t *status_);
